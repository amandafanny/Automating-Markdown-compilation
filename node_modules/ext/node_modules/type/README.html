...
<pre><code class="language-javascript">const allowedKeys = [&quot;foo&quot;];
...
<h5>Confirming on property values</h5>
...
<h5>Denying empty iterables</h5>
<p>Pass <code>denyEmpty</code> option to require non empty iterables</p>
<pre><code class="language-javascript">ensureIterable([], { denyEmpty: true }); // Thrown TypeError: [] is not expected iterable
</code></pre>
<h5>Confirming on items</h5>
